...
#+begin_src emacs-lisp
  ...
  ;; --------------------------------
  ;; AUCTeX (major LaTeX environment)
  ;; --------------------------------
  (use-package tex
    :ensure auctex
    :defer t
    ...
    ;; Turn on forward + inverse search automatically
    (add-hook 'TeX-after-compilation-finished-functions
              #'TeX-revert-document-buffer))

  ;; -----------------------------
  ;; RefTeX (citations, labels, TOC)
  ;; -----------------------------
  (use-package reftex
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'format-all
    ;; Register elisp-format as the formatter for emacs-lisp-mode
    (add-to-list 'format-all-formatters
                 '(elisp-format
                   "elisp-format"
                   ("elisp-format-buffer")  ;; command to run
                   nil                      ;; no args needed
...
#+begin_src emacs-lisp
  (use-package org-modern
    ...
    :config
    ;; Optional tweaks
    ;; Replace standard bullets with UTF-8 bullets
    (setq org-modern-star '("◉" "◆" "●" "○" "✸" "✿"))
    
    ;; Make emphasis (bold/italic) more visible
    (setq org-modern-block-fringe nil) ;; remove block fringe indicators
    
    ;; Optional: modernize tables
    (setq org-modern-table nil) ;; set to t to add table borders and shading

    ;; Automatically refresh when themes change
    (add-hook 'after-load-theme-hook #'org-modern-reload))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setenv "SSH_AUTH_SOCK" "/home/loicdm/.bitwarden-ssh-agent.sock")
